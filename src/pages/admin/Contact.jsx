...
function ContactUser() {
  ...
  const exportToExcel = () => {
    try {
      ...
      XLSX.writeFile(workbook, `contacts_data_${new Date().toISOString().split('T')[0]}.xlsx`);
          ...
          {error && (
            <div style={styles.errorContainer}>
              ...
              <button 
                ...
                style={{...styles.exportButton, background: 'linear-gradient(135deg, #dc2626 0%, #b91c1c 100%)', marginTop: '10px'}}
              >
                Retry
              </button>
            </div>
            ...
            <div style={styles.tableContainer}>
              {filteredContacts.length === 0 ? (
                <div style={styles.noData}>
                  {searchTerm ? 'No contacts found matching your search.' : 'No contact messages available.'}
                </div>
              ) : (
                    ...
                    {filteredContacts.map((contact, index) => (
                      ...
                      >
                        ...
                        <td style={styles.tableCell}>
                          <span style={{
                            ...styles.statusBadge,
                            ...(contact?.status === 'read' ? styles.statusRead : styles.statusUnread)
                          }}>
